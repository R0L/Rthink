...
class Order extends Admin {
    ...
    public function shoppingcart(Request $request) {
        return $this->index($request, OrderModel::ORDER_SHOPPINGCART);
    }
    ...
    public function haveinhand(Request $request) {
        return $this->index($request, OrderModel::ORDER_HAVEINHAND);
    }
    ...
    public function haswontheprize(Request $request) {
        return $this->index($request, OrderModel::ORDER_HASWONTHEPRIZE);
    }
    ...
    public function notwinning(Request $request) {
        return $this->index($request, OrderModel::ORDER_NOTWINNING);
    }
    ...
    public function sunsheet(Request $request) {
        return $this->index($request, OrderModel::ORDER_SUNSHEET);
    }
