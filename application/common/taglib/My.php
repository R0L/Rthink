...
class My extends TagLib {
    ...
    // 定义标签
    protected $tags = [
        'ueditor' => ['attr' => 'name,content,height', 'close' => 0],
        'umeditor' =>['attr' => 'name,content,height', 'close' => 0],
        'webuploader' =>['attr' => 'name,url,word', 'close' => 0],
    ];
    ...
    public function tagumeditor($tag) {
        ...
        $link = <<<EOF
                <!-- 加载编辑器的容器 -->
                <link rel="stylesheet" href="/public/static/umeditor1_2_2/themes/default/css/umeditor.min.css">
